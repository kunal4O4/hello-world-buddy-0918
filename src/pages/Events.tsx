  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {/* First Banner - Prayukti 2025 */}
          

          {/* Second Banner - All Events Gallery */}
          <div className="relative group overflow-hidden rounded-2xl cursor-pointer hover-lift bg-gradient-to-br from-primary/20 via-accent/20 to-primary/20 border border-primary/30" onClick={() => window.location.href = '/events-gallery'}>
            <div className="aspect-[16/10] relative flex flex-col items-center justify-center p-6">
              <div className="absolute inset-0 bg-grid-pattern opacity-10" />
              <div className="relative z-10 text-center">
                <div className="mb-4">
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-primary/20 mb-4 group-hover:scale-110 transition-transform">
                    <CalendarDays className="w-10 h-10 text-primary" />
                  </div>
                </div>
                <h2 className="text-2xl md:text-3xl font-bold mb-3">Explore All Events</h2>
                <p className="text-muted-foreground mb-4">Discover 30+ exciting events across all categories</p>
        ...
        <div className="relative space-y-4 md:space-y-8">
          ...
          return <div key={event.id} className="flex gap-3 md:gap-6 relative">
                {/* Date Column */}
                ...
                {/* Event Card */}
                <div className="flex-1 bg-card border border-border rounded-xl p-4 md:p-6 hover:shadow-lg transition-all cursor-pointer animate-fade-in" onClick={() => setSelectedEvent(event)}>
